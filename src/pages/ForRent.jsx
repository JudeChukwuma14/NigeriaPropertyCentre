      ...
      <section>
        <div className=" w-[95%] md:w-[90%] mx-auto lg:w-[75%] mt-8 lg:flex lg:justify-between">
          ...
          <div className=" bg-[#f4f5f4] md:px-4 md:py-5 hidden md:block">
              ...
              There are 25,615 available flats, houses, land and commercial property for rent in Nigeria. The property have been listed by estate agents who can be contacted using the contact information provided for each property listing. The list can be filtered by price, furnishing and recency.
              </p>
            </div>
            <div className=" bg-[#f4f5f4] md:mt-4 py-5 px-4 w-[100%]">
              <h1 className=" font-bold md:text-xl">Quick Filter</h1>
              <span className=" flex flex-wrap mt-3  gap-2 text-[0.95rem] md:gap-5 md:text-[1rem]">
                ...
                <a className="hover:text-[#e23c3c] hidden md:block" href="">Event Center/Venues</a>
              </span>
              ...
              <span className=" flex flex-wrap gap-2 md:gap-5 text-[0.95rem] md:text-[1rem]">
                ...
                <a className="hover:text-[#e23c3c] hover:text-[#e23c3c]hidden md:block"  href="">Ogun</a>
              ...
              {showMore &&(
                <span className=" flex flex-wrap gap-2 lg:gap-5 text-[0.95rem] lg:text-[1rem]">
            ...
            <div className="bg-[#fffbf0] mt-5  lg:my-5 border">
              <div className=" p-3 hidden md:block hover:text-[#e23c3c] text-[0.9rem] md:text-[1rem]">
                <a href="">Four Bedrooms Semi-detached Duplex</a>
              </div>
                ...
                <div className=" px-4 md:w-[60%] md:py-3 ">
                  <a className=" text-[#e23c3c] font-semibold lg:font-bold md:text-[1rem]" href="">4 Bedrooms Semi-detached Duplex for rent</a>
                  <span className=" flex items-center gap-1 md:my-1">
                   <h1 className=" md:text-[1rem]"><CiLocationOn /></h1>
                   <p className=" font-semibold text-[0.9rem]">Orchid Road, Lafiaji, Lekki,  Quarters, Lagos</p>
                  </span>
